...
<body>
	...
	<label id="lb-title"><i class="fa fa-briefcase"></i> Quản lý danh sách các danh mục y tế</label>
	...
	<div id="div-content">
		...
		<s:div>
			<table class="table sortable table-hover table-responsive">
				<thead>
					<tr>
						<th class="tieude">Danh mục</th>
						<th class="ngaygio">Hiển thị</th>
						<th class="ngaygio">Số bài viết</th>
						<th></th>
					</tr>
				</thead>
				<tbody>
				<s:iterator value="list">
					<tr>
						...
						<td> <s:property value="hienThi"/> </td>
						<td class="td-10"> <s:property value="soBaiViet"/> </td>
						<td class="td-10">
							<button type="button" class="btn btn-primary btn-xs"
								onclick="CapNhat('${ idDanhMuc }');">
								Sửa</button>
							<button type="button" class="btn btn-primary btn-xs"
								onclick="XoaDanhMuc('${ idDanhMuc }');">
								Xóa</button>
						</td>
					</tr>
				</s:iterator>
