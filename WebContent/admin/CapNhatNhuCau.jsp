...
<body>
	...
	<label id="lb-title"><i class="fa fa-compass"></i> Cập nhật nhu cầu y tế</label>
	...
	<s:div id="div-content">
			...
			<s:div cssClass="div-content-home">
				<form action="cap-nhat-nhu-cau.action" enctype="multipart/form-data"
					...
					<br>
					<s:hidden name="idNhuCau" value="%{ nhuCau.idDichVu}"></s:hidden>
					<s:label value="Tiêu đề nhu cầu"></s:label>
					<s:textfield name="tenNhuCau" cssClass="form-control" value="%{ nhuCau.baiViet.tenBaiViet}"></s:textfield>
					<br>
					...
					<s:select name="danhMuc" list="list" listValue="tenDanhMuc"
								...
								value="nhuCau.baiViet.danhMuc.idDanhMuc" >
					</s:select>
					<br>
					<s:label value="Chi tiết nhu cầu"></s:label>
					<s:textarea name="moTa" rows="10" cssClass="form-control" value="%{ nhuCau.baiViet.moTa}"></s:textarea>
					<br>
					...
					<s:textfield name="nhaCungCap" cssClass="form-control" value="%{ nhuCau.baiViet.tenTacGia}"></s:textfield>
					<br>
					<s:label value="Địa điểm mong muốn"></s:label>
					<s:textfield name="diaDiem" cssClass="form-control" value="%{ nhuCau.diaChiTrienKhai}"></s:textfield>
					<br>
					<s:div cssClass="div-col-100">
						...
						<s:div cssClass="div-col-50">
							...
							<s:textfield name="email" cssClass="form-control" value="%{ nhuCau.emailLienHe}"></s:textfield>
							<br>
							<s:label value="Ngày kết thúc"></s:label>
							<s:textfield name="ngayKetThuc" id="ngayKetThuc" value="%{ nhuCau.ngayKetThuc}"
								cssClass="form-control"></s:textfield>
						</s:div>
					...
					<br>
					<br>
					<s:submit value="Cập nhật nhu cầu"
