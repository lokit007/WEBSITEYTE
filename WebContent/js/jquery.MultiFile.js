...
if (window.jQuery)(function ($) {
	...
	*/
	$.fn.MultiFile.options = { //$.extend($.fn.MultiFile, { options: {
		...
		STRING: {
			remove: 'x',
			denied: 'Không thể chọn a $ext file.\nThử lại...',
			file: '$file',
			selected: 'Đã chọn : $file',
			duplicate: 'Đã tồn tại trong danh sách :\n$file',
			toomuch: 'Các tập tin đã chọn vượt quá kích thước tối đa ($size)',
			toomany: 'Số lượng tệp vượt quá mức cho phép (max: $max)',
			toobig: '$file quá lớn (max $size)'
		},
