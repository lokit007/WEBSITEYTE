...
public class ThongKeDAO {
	...
	public List<ThongKeDanhMuc> getThongKeDanhMuc() throws SQLException {
	...
	public List<ThongKeTaiKhoan> getThongKeTaiKhoan() throws SQLException {
		String sql = "select * from (select TAIKHOAN.TaiKhoan, HoTen, (select COUNT(*) from BAIVIET "
				+ "inner join DICHVU on DICHVU.IdBaiViet=BAIVIET.IdBaiViet "
				+ "where BAIVIET.TaiKhoan=TAIKHOAN.TaiKhoan and LoaiHinhDichVu not like N'Nhu cầu') as SoDichVu, "
				+ "(select COUNT(*) from BAIVIET inner join DICHVU on DICHVU.IdBaiViet=BAIVIET.IdBaiViet "
				+ "where BAIVIET.TaiKhoan=TAIKHOAN.TaiKhoan and LoaiHinhDichVu not like N'Nhu cầu') as SoNhuCau, "
				+ "(select COUNT(*) from BAIVIET left join DICHVU on DICHVU.IdBaiViet=BAIVIET.IdBaiViet "
				+ "where BAIVIET.TaiKhoan=TAIKHOAN.TaiKhoan and IdDichVu is null) as SoBaiViet "
